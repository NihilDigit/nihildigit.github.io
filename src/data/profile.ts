export const PROFILE = {
  ...
  summary:
    "Undergraduate researcher behind TongXing, ANVIL, and RAFNet, working on assistive edge AI, mobile NPU deployment, computer vision, video systems, and practical open-source maintenance.",
  llmsAbout: [
    "Shibo Liu is an undergraduate at North China University of Science and Technology (NCST), studying intelligence science.",
    "RAFNet was his first academic project and his practical entry into computer vision. TongXing ran in parallel from the deployment side as a 4C2026 competition project for blind and low-vision assistive systems, with NPU obstacle warning, offline speech, and a local LLM agent that closes touch-first app tasks through MCP tools and Android accessibility actions. It made the potential of mobile NPUs and engineering optimization concrete.",
    ...
    "He also maintains tools and contributes upstream. waybar-ai-usage began as a personal desktop widget and became his first real open-source maintenance experience after users started filing issues and PRs. coding-agents-setup records the coding-agent setup he actually uses. Animeko is a long-term upstream contribution target driven by his own usage.",
  ],
} as const;
