export const PROFILE = {
  ...
  llmsAbout: [
    ...
    "He also maintains tools and contributes upstream. waybar-ai-usage began as a personal desktop widget and became his first real open-source maintenance experience after users started filing issues and PRs. coding-agents-setup records the coding-agent setup he actually uses. He is a member of the open-ani organization with write access to its repositories, contributing across animeko, mediamp, and anitorrent — mostly player and cross-platform support (Windows ARM64, Linux rendering, touch interaction) and media acquisition (PikPak, HLS) — alongside smaller upstream patches to tools he uses daily, such as Fresh and CMake.",
  ],
} as const;
